...
JNIFrame *ensureJNILrefCapacity(int cap)
{
    ...
    JNIFrame *frame = (JNIFrame*)threadSelf()->current_core()->m_mode->frame;
...
JNIFrame *pushJNILrefFrame(int cap) {
    ...
    //ExecEnv *ee = getExecEnv();
    //JNIFrame *frame = (JNIFrame*)ee->last_frame;
    JNIFrame* frame = threadSelf()->current_core()->m_mode->frame;
...
//     new_frame->ostack = (uintptr_t*)(new_frame + 1);
    ...
    //ee->last_frame = (Frame*)new_frame;
    threadSelf()->current_core()->m_mode->frame = (Frame*)new_frame;
    return new_frame;
}
...
void popJNILrefFrame() {
    ...
    threadSelf()->current_core()->m_mode->frame = (Frame*)prev;
}
