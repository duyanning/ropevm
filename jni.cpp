...
JNIFrame *ensureJNILrefCapacity(int cap)
{
    ...
    JNIFrame *frame = (JNIFrame*)threadSelf()->get_current_core()->m_mode->frame;
...
Object *addJNILref(Object *ref)
{
    ...
    //ExecEnv *ee = getExecEnv();
    //JNIFrame *frame = (JNIFrame*)ee->last_frame;
    //assert(ee->last_frame == threadSelf()->get_current_core()->m_mode->frame);
    JNIFrame *frame = (JNIFrame*)threadSelf()->get_current_core()->m_mode->frame;
...
JNIFrame *pushJNILrefFrame(int cap) {
    ...
    //ExecEnv *ee = getExecEnv();
    //JNIFrame *frame = (JNIFrame*)ee->last_frame;
    JNIFrame* frame = threadSelf()->get_current_core()->m_mode->frame;
...
//     new_frame->ostack = (uintptr_t*)(new_frame + 1);
    ...
    //ee->last_frame = (Frame*)new_frame;
    threadSelf()->get_current_core()->m_mode->frame = (Frame*)new_frame;
    return new_frame;
}
...
void popJNILrefFrame() {
    ...
    threadSelf()->get_current_core()->m_mode->frame = (Frame*)prev;
}
