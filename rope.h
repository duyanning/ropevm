...
public:
    ...
    u2 max_stack;
    u2 max_locals;
    u2 args_count; // D, J += 2 to args_count, see SCAN_SIG, including 'this'
    u2 throw_table_size;
...
public:
    ...
    bool is_private() const {  return access_flags & ACC_PRIVATE;  }
...
public:
    ...
    // if field is static, use static_value
    //    if field is 4 bytes, only use static_value
    //    if field is 8 bytes, use static value to store low bits, use offset to store high bits
    // if field is non-static, use offset
...
#define IS_CLASS(object)                (object->classobj && IS_CLASS_CLASS(CLASS_CB(object->classobj)))
...
extern Object *allocObject(Class *classobj);
extern Object *allocTypeArray(int type, int size);
extern Object *allocArray(Class *classobj, int size, int el_size);
...
extern void registerStaticObjectRef(Class** clsob);
extern void registerStaticObjectRefLocked(Class** clsob);
...
extern Class *defineClass(const char *classname, char *data, int offset, int len, Object *class_loader);
extern void linkClass(Class *classobj);
extern Class *initClass(Class *classobj);
extern Class *findSystemClass(const char*);
extern Class *findSystemClass0(const char*);
extern Class *loadSystemClass(const char*);

extern Class *findHashedClass(char *, Object *);
extern Class *findPrimitiveClass(char);
extern Class *findArrayClassFromClassLoader(const char*, Object *);
...
#define findArrayClassFromClass(name, classobj)                         \
    findArrayClassFromClassLoader(name, CLASS_CB(classobj)->class_loader)
#define findArrayClass(name) findArrayClassFromClassLoader(name, NULL)

extern Class *findClassFromClassLoader(char *, Object *);
#define findClassFromClass(name, classobj)                              \
    findClassFromClassLoader(name, CLASS_CB(classobj)->class_loader)

extern void freeClassData(Class *classobj);
...
extern FieldBlock *findField(Class *, const char*, const char*);
extern MethodBlock *findMethod(Class *classobj, const char* methodname, const char* type);
extern FieldBlock *lookupField(Class *, const char*, const char*);
extern MethodBlock *lookupMethod(Class *classobj, const char* methodname, const char* type);
extern MethodBlock *lookupVirtualMethod(Object *ob, MethodBlock *mb);
extern Class *resolveClass(Class *classobj, int index, int init);
extern MethodBlock *resolveMethod(Class *classobj, int index);
extern MethodBlock *resolveInterfaceMethod(Class *classobj, int index);
extern FieldBlock *resolveField(Class *classobj, int index);
extern uintptr_t resolveSingleConstant(Class *classobj, int index);
extern int peekIsFieldLong(Class *classobj, int index);

extern MethodBlock* get_rvp_method(MethodBlock* complete);


/* cast */

extern char isSubClassOf(Class *classobj, Class *test);
extern char isInstanceOf(Class *classobj, Class *test);
extern char arrayStoreCheck(Class *classobj, Class *test);
...
extern void signalChainedExceptionEnum(int excep_enum, const char* excep_mess, Object *cause);
extern void signalChainedExceptionName(const char* excep_name, const char* excep_mess, Object *cause);
extern void signalChainedExceptionClass(Class *excep_class, const char* excep_mess, Object *cause);
...
extern Object *setStackTrace0(int max_depth);
...
extern int utf8Hash(const char *utf8);
extern int utf8Comp(const char *utf81, const char *utf82);
extern void convertUtf8(const char* utf8, unsigned short *buff);
extern char *findHashedUtf8(const char *string, int add_if_absent);
extern char *copyUtf8(const char *string);
...
extern char *slash2dots2buff(const char *utf8, char *buff, int buff_len);
...
extern const char* getBootDllPath();
extern char *getDllName(char *name);
extern void initialiseDll(InitArgs *args);
extern uintptr_t *resolveNativeWrapper(Class *classobj, MethodBlock *mb, uintptr_t *ostack);
...
extern void *nativeLibSym(void *handle, const char *symbol);
...
extern Object *getClassConstructors(Class *classobj, int publi);
extern Object *getClassMethods(Class *classobj, int publi);
extern Object *getClassFields(Class *classobj, int publi);
extern Object *getClassInterfaces(Class *classobj);
extern Object *getClassClasses(Class *classobj, int publi);
extern Class *getDeclaringClass(Class *classobj);
extern Class *getEnclosingClass(Class *classobj);
extern Object *getEnclosingMethodObject(Class *classobj);
extern Object *getEnclosingConstructorObject(Class *classobj);
extern Object *getClassAnnotations(Class *classobj);
...
extern char *getCommandLineProperty(const char* key);

/* access */

extern int checkClassAccess(Class *classobj1, Class *classobj2);
extern int checkMethodAccess(MethodBlock *mb, Class *classobj);
extern int checkFieldAccess(FieldBlock *fb, Class *classobj);
...
inline
void*
array_elem_addr(Object* array, int index, size_t type_size)
{
