...
uintptr_t *getClass(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *ob = (Object*)*ostack;
    *ostack++ = (uintptr_t)ob->classobj;
    return ostack;
}

uintptr_t *jamClone(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *ob = (Object*)*ostack;
...
uintptr_t *jamWait(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *notify(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *notifyAll(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *obj = (Object *)*ostack;
    objectNotifyAll(obj);
    return ostack;
}
...
uintptr_t *arraycopy(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ...
    if((src == NULL) || (dest == NULL))
        ...
        ClassBlock *scb = CLASS_CB(src->classobj);
        ClassBlock *dcb = CLASS_CB(dest->classobj);
        char *sdata = (char*)ARRAY_DATA(src);
        char *ddata = (char*)ARRAY_DATA(dest);

        if((scb->name[0] != '[') || (dcb->name[0] != '['))
            goto storeExcep;

        if((start1 < 0) || (start2 < 0) || (length < 0)
           || ((u4)(start1 + length) > ARRAY_LEN(src))
           || ((u4)(start2 + length) > ARRAY_LEN(dest))) {
            signalException(java_lang_ArrayIndexOutOfBoundsException, NULL);
            return ostack;
        }

        if(isInstanceOf(dest->classobj, src->classobj)) {
            int size;
		...
		default:
            ...
            for(i = 0; i < length; i++) {
                if((*sob != NULL) && !arrayStoreCheck(dest->classobj, (*sob)->classobj))
                    goto storeExcep;
                *dob++ = *sob++;
            }
        }
...
uintptr_t *identityHashCode(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *ob = (Object*)*ostack;
...
uintptr_t *availableProcessors(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = nativeAvailableProcessors();
    return ostack;
}

uintptr_t *freeMemory(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *(u8*)ostack = freeHeapMem();
    return ostack + 2;
}

uintptr_t *totalMemory(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *(u8*)ostack = totalHeapMem();
    return ostack + 2;
}

uintptr_t *maxMemory(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *(u8*)ostack = maxHeapMem();
    return ostack + 2;
}

uintptr_t *gc(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    gc1();
    return ostack;
}

uintptr_t *runFinalization(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    runFinalizers();
    return ostack;
}

uintptr_t *exitInternal(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    int status = ostack[0];
    jamvm_exit(status);
    /* keep compiler happy */
    return 0;
...
uintptr_t *nativeLoad(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *mapLibraryName(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    char *name = String2Cstr((Object*)ostack[0]);
...
uintptr_t *propertiesPreInit(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *properties = (Object *)*ostack;
    addDefaultProperties(properties);
    return ostack;
}

uintptr_t *propertiesPostInit(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *properties = (Object *)*ostack;
...
uintptr_t *isInstance(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    Object *ob = (Object*)ostack[1];

    *ostack++ = ob == NULL ? FALSE : (uintptr_t)isInstanceOf(clazz, ob->classobj);
    return ostack;
}

uintptr_t *isAssignableFrom(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
...
uintptr_t *isInterface(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    *ostack++ = IS_INTERFACE(cb) ? TRUE : FALSE;
    return ostack;
}

uintptr_t *isPrimitive(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    *ostack++ = IS_PRIMITIVE(cb) ? TRUE : FALSE;
    return ostack;
}

uintptr_t *isArray(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    *ostack++ = IS_ARRAY(cb) ? TRUE : FALSE;
    return ostack;
}

uintptr_t *isMember(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    *ostack++ = IS_MEMBER(cb) ? TRUE : FALSE;
    return ostack;
}

uintptr_t *isLocal(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    *ostack++ = IS_LOCAL(cb) ? TRUE : FALSE;
    return ostack;
}

uintptr_t *isAnonymous(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    *ostack++ = IS_ANONYMOUS(cb) ? TRUE : FALSE;
    return ostack;
}

uintptr_t *getEnclosingClass0(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    *ostack++ = (uintptr_t) getEnclosingClass(clazz);
    return ostack;
}

uintptr_t *getEnclosingMethod0(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    *ostack++ = (uintptr_t) getEnclosingMethodObject(clazz);
    return ostack;
}

uintptr_t *getEnclosingConstructor(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    *ostack++ = (uintptr_t) getEnclosingConstructorObject(clazz);
    return ostack;
}

uintptr_t *getClassSignature(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
    Object *string = NULL;
...
uintptr_t *getSuperclass(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ClassBlock *cb = CLASS_CB(GET_CLASS(ostack[0]));
...
uintptr_t *getComponentType(Class *clazz, MethodBlock *mb, uintptr_t *ostack) {
    Class *classobj = GET_CLASS(ostack[0]);
    ...
    if(IS_ARRAY(cb))
        switch(cb->name[1]) {
            case '[':
                componentType = findArrayClassFromClass(&cb->name[1], classobj);
                break;
...
uintptr_t *getName(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *getDeclaredClasses(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    int publi = ostack[1];
    *ostack++ = (uintptr_t) getClassClasses(clazz, publi);
    return ostack;
}

uintptr_t *getDeclaringClass0(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    *ostack++ = (uintptr_t) getDeclaringClass(clazz);
    return ostack;
}

uintptr_t *getDeclaredConstructors(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    int publi = ostack[1];
    *ostack++ = (uintptr_t) getClassConstructors(clazz, publi);
    return ostack;
}

uintptr_t *getDeclaredMethods(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    int publi = ostack[1];
    *ostack++ = (uintptr_t) getClassMethods(clazz, publi);
    return ostack;
}

uintptr_t *getDeclaredFields(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    int publi = ostack[1];
    *ostack++ = (uintptr_t) getClassFields(clazz, publi);
    return ostack;
}

uintptr_t *getClassDeclaredAnnotations(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    *ostack++ = (uintptr_t) getClassAnnotations(clazz);
    return ostack;
}

uintptr_t *getInterfaces(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
    *ostack++ = (uintptr_t) getClassInterfaces(clazz);
    return ostack;
}

uintptr_t *getClassLoader(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(*ostack);
    *ostack++ = (uintptr_t)CLASS_CB(clazz)->class_loader;
    return ostack;
}

uintptr_t *getClassModifiers(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *clazz = GET_CLASS(ostack[0]);
...
uintptr_t *forName0(uintptr_t *ostack, int resolve, Object *loader) {
    ...
    classobj = findClassFromClassLoader(cstr, loader);
...
uintptr_t *throwException(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *excep = (Object *)ostack[0];
    setException(excep);
    return ostack;
}

uintptr_t *hasClassInitializer(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *fillInStackTrace(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
     *ostack++ = (uintptr_t) setStackTrace();
    return ostack;
}

uintptr_t *getStackTrace(Class *classobj, MethodBlock *m, uintptr_t *ostack) {
    Object *self = (Object *)*ostack;
    *ostack++ = (uintptr_t) convertStackTrace(self);
    return ostack;
}

/* gnu.classpath.VMStackWalker */

uintptr_t *getCallingClass(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    assert(false);
...
uintptr_t *getCallingClassLoader(Class *clazz, MethodBlock *mb, uintptr_t *ostack) {
    //assert(false);
    Class *classobj = getCallerCallerClass();

    *ostack++ = (uintptr_t) (classobj ? CLASS_CB(classobj)->class_loader : NULL);
    return ostack;
}

uintptr_t *getClassContext(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    assert(false);
    ...
    if((last = getCallerFrame(threadSelf()->get_current_spmt_thread()->get_current_mode()->frame)) == NULL)
        ...
        if(array != NULL) {
            Class **data = (Class**)ARRAY_DATA(array);

            do {
                for(; bottom->mb != NULL; bottom = bottom->prev)
                    *data++ = bottom->mb->classobj;
...
uintptr_t *firstNonNullClassLoader(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ...
    do {
        for(; last->mb != NULL; last = last->prev)
            if((loader = CLASS_CB(last->mb->classobj)->class_loader) != NULL)
                goto out;
    } while((last = last->prev)->prev != NULL);
...
uintptr_t *getPrimitiveClass(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *defineClass0(Class *clazz, MethodBlock *mb, uintptr_t *ostack) {
    ...
    if(array == NULL)
        ...
        if((offset < 0) || (data_len < 0) ||
           ((u4)(offset + data_len) > ARRAY_LEN(array)))
            signalException(java_lang_ArrayIndexOutOfBoundsException, NULL);
        else {
            char *data = (char*)ARRAY_DATA(array);
            ...
            if((classobj = defineClass(cstr, data, offset, data_len, class_loader)) != NULL) {
                INST_DATA(classobj)[pd_offset] = pd;
                linkClass(classobj);
            }
...
uintptr_t *findLoadedClass(Class *clazz, MethodBlock *mb, uintptr_t *ostack) {
    ...
    classobj = findHashedClass(cstr, class_loader);
...
uintptr_t *resolveClass0(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *getBootClassPathSize(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = bootClassPathSize();
    return ostack;
}

uintptr_t *getBootClassPathResource(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *string = (Object *) ostack[0];
...
uintptr_t *constructNative(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
...
uintptr_t *getMethodModifiers(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
...
uintptr_t *getMethodSignature(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
    MethodBlock *mb = &(CLASS_CB(decl_class)->methods[ostack[2]]);
    Object *string = NULL;
...
uintptr_t *getDefaultValue(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
    MethodBlock *mb = &(CLASS_CB(decl_class)->methods[ostack[2]]);
...
uintptr_t *getMethodDeclaredAnnotations(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
    MethodBlock *mb = &(CLASS_CB(decl_class)->methods[ostack[2]]);
...
uintptr_t *getParameterAnnotations(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
    MethodBlock *mb = &(CLASS_CB(decl_class)->methods[ostack[2]]);
...
uintptr_t *getFieldModifiers(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
...
uintptr_t *getFieldSignature(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
    FieldBlock *fb = &(CLASS_CB(decl_class)->fields[ostack[2]]);
    Object *string = NULL;
...
uintptr_t *getFieldDeclaredAnnotations(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *decl_class = (Class*)ostack[1];
    FieldBlock *fb = &(CLASS_CB(decl_class)->fields[ostack[2]]);
...
Object *getAndCheckObject(uintptr_t *ostack, Class *type) {
    ...
    if(!isInstanceOf(type, ob->classobj)) {
...
uintptr_t *getField(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *getPrimitiveField(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *field_type = (Class *)ostack[3];
...
uintptr_t *setField(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *field_type = (Class *)ostack[3];
...
uintptr_t *setPrimitiveField(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Class *field_type = (Class *)ostack[3];
    int type_no = ostack[6];
...
uintptr_t *invokeNative(Class *classobj, MethodBlock *mb2, uintptr_t *ostack) {
    Object *array = (Object*)ostack[2];
...
uintptr_t *intern(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *string = (Object*)ostack[0];
...
uintptr_t *currentThread(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
	//assert(false);
    //*ostack++ = (uintptr_t)getExecEnv()->thread;
    *ostack++ = (uintptr_t)threadSelf()->thread;
    return ostack;
}

/* static method create(Ljava/lang/Thread;J)V */
uintptr_t *create(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *self = (Object *)ostack[0];
    long long stack_size = *((long long*)&ostack[1]);
    createJavaThread(self, stack_size);
    return ostack;
}

/* static method sleep(JI)V */
uintptr_t *jamSleep(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *interrupt(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *self = (Object *)*ostack;
    Thread *thread = threadSelf0(self);
    if(thread)
...
uintptr_t *isAlive(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *self = (Object *)*ostack;
    Thread *thread = threadSelf0(self);
...
uintptr_t *yield(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Thread *thread = threadSelf();
    threadYield(thread);
    return ostack;
}
...
uintptr_t *isInterrupted(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *self = (Object *)*ostack;
    Thread *thread = threadSelf0(self);
...
uintptr_t *interrupted(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Thread *thread = threadSelf();
...
uintptr_t *nativeSetPriority(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    return ostack+1;
}

/* instance method holdsLock(Ljava/lang/Object;)Z */
uintptr_t *holdsLock(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *getState(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    Object *self = (Object *)*ostack;
    Thread *thread = threadSelf0(self);
    const char *state = thread ? getThreadStateString(thread) : "TERMINATED";
...
uintptr_t *getStack(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    assert(false);
    ...
    frame = threadSelf()->get_current_spmt_thread()->get_current_mode()->frame;
    depth = 0;
    ...
    if(stack != NULL && names != NULL && classes != NULL) {
        Class **dcl = (Class**)ARRAY_DATA(classes);
        Object **dnm = (Object**)ARRAY_DATA(names);
...
uintptr_t *getThreadCount(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = getThreadsCount();
    return ostack;
}

uintptr_t *getPeakThreadCount(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = getPeakThreadsCount();
    return ostack;
}

uintptr_t *getTotalStartedThreadCount(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *(u8*)ostack = getTotalStartedThreadsCount();
    return ostack + 2;
}

uintptr_t *resetPeakThreadCount(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    resetPeakThreadsCount();
    return ostack;
}

uintptr_t *findMonitorDeadlockedThreads(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = (uintptr_t)NULL;
    return ostack;
}

uintptr_t *getThreadInfoForId(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    assert(false);
    ...
    if(thread != NULL) {
        ...
        if(info_class != NULL) {
            ...
            if(init != NULL) {
                ...
                last = threadSelf()->get_current_spmt_thread()->get_current_mode()->frame;
...
uintptr_t *objectFieldOffset(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *compareAndSwapInt(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *compareAndSwapLong(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
...
uintptr_t *putOrderedInt(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
...
uintptr_t *putOrderedLong(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
...
uintptr_t *putIntVolatile(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
    volatile uintptr_t *addr = (uintptr_t*)((char *)ostack[1] + offset);
    uintptr_t value = ostack[4];
...
uintptr_t *getIntVolatile(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
    volatile uintptr_t *addr = (uintptr_t*)((char *)ostack[1] + offset);
...
uintptr_t *putLong(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
    long long value = *((long long *)&ostack[4]);
    long long *addr = (long long*)((char*)ostack[1] + offset);
...
uintptr_t *getLongVolatile(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
    volatile long long *addr = (long long*)((char*)ostack[1] + offset);
...
uintptr_t *getLong(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
    long long *addr = (long long*)((char*)ostack[1] + offset);
...
uintptr_t *putObject(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    long long offset = *((long long *)&ostack[2]);
    uintptr_t *addr = (uintptr_t*)((char *)ostack[1] + offset);
    uintptr_t value = ostack[4];
...
uintptr_t *arrayBaseOffset(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = (uintptr_t) ARRAY_DATA((Object*)NULL);
    return ostack;
}

uintptr_t *arrayIndexScale(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
...
uintptr_t *unpark(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    return ostack;
}

uintptr_t *park(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    return ostack;
}

uintptr_t *vmSupportsCS8(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    *ostack++ = FALSE;
    return ostack;
}
...
uintptr_t *nativeUnloadDll(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
