...
char *getCommandLineProperty(const char *key) {
    int i;
...
void setProperty(Object* properties, const char* key, const char* value) {
    Object *k = Cstr2String(key);
    Object *v = Cstr2String(value ? value : (char*)"?");
...
char *getJavaHome() {
    ...
    return env ? env : (char*)INSTALL_DIR;
}
