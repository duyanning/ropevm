...
uintptr_t *getClassContext(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ...
    if((last = getCallerFrame(threadSelf()->get_current_st()->get_current_mode()->frame)) == NULL)
...
uintptr_t *getStack(Class *classobj, MethodBlock *mb, uintptr_t *ostack) {
    ...
    frame = threadSelf()->get_current_st()->get_current_mode()->frame;
    depth = 0;
    ...
    if(thread != NULL) {
        ...
        if(info_class != NULL) {
            ...
            if(init != NULL) {
                ...
                last = threadSelf()->get_current_st()->get_current_mode()->frame;
