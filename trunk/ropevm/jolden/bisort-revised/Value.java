...
class Value
{
    ...
    // int _p_slice_for_bisort(int spr_val, boolean direction)
    // {
    //     return spr_val;
    // }
    ...
    int _p_slice_for_bimerge(int spr_val, boolean direction)
    {
        return spr_val;
    }
    ...
    void _p_slice_for_swapValRight(Value n)
    {
    }
    ...
    void _p_slice_for_swapValLeft(Value n)
    {
    }
